...
const TrashBasketList = ({country, handleDeleteClick}) => {
    ...
    // useEffect(() =>
    // {
    //     const getCountry = JSON.parse(localStorage.getItem('countryId')) || [];
    //     setCountryArr(getCountry)
    // }, [])
    // const handleDeleteClick = (id) =>
    // {
    //     const newArrCountry = countryArr.filter(item => item.id !== item.id);
    //     setCountryArr(newArrCountry)
    //     localStorage.setItem('countryId', JSON.stringify(newArrCountry));
    // }
